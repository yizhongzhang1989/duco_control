...
package_name = 'ft_sensor_dashboard'
...
setup(
    ...
    description='Web-based live dashboard for F/T wrench topics (SSE-streamed).',
    license='MIT',
    tests_require=['pytest'],
    entry_points={
        'console_scripts': [
            'dashboard = ft_sensor_dashboard.dashboard_node:main',
        ],
    },
)
